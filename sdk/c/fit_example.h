...
#define FIT_VIDEO_CLIP_MESG_SIZE                                                2
#define FIT_VIDEO_CLIP_MESG_DEF_SIZE                                            8
...
typedef enum
{
   FIT_VIDEO_CLIP_FIELD_NUM_WEIGHT_DISPLAY_UNIT = 9
} FIT_VIDEO_CLIP_FIELD_NUM;

typedef enum
{
   FIT_VIDEO_CLIP_MESG_WEIGHT_DISPLAY_UNIT,
