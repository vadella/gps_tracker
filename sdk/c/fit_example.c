...
static const FIT_VIDEO_CLIP_MESG_DEF video_clip_mesg_def =
{
   0, // reserved_1
   FIT_ARCH_ENDIAN, // arch
   FIT_MESG_NUM_VIDEO_CLIP, // global_mesg_num
   1, // num_fields
   { // field_def_num, size, base_type
      FIT_VIDEO_CLIP_FIELD_NUM_WEIGHT_DISPLAY_UNIT, (sizeof(FIT_FIT_BASE_UNIT)*1), FIT_BASE_TYPE_UINT16,
   }
};
...
const FIT_CONST_MESG_DEF_PTR fit_mesg_defs[] =
{
   ...
   (FIT_CONST_MESG_DEF_PTR) &video_clip_mesg_def,
